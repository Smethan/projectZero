...
for source in test_serial.c test_hs_monitor.c test_capture_pool.c test_wifi_init.c test_hs_targets.c test_handshake_scope.c test_hs_scan_lifecycle.c test_hs_exchange.c test_hs_artifact.c test_hs_client.c test_hs_ap.c test_hs_fcs.c; do
